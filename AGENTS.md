...
This project is indexed by GitNexus as **Onelap-Strava-GoGoGo** (2842 symbols, 5560 relationships, 180 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
